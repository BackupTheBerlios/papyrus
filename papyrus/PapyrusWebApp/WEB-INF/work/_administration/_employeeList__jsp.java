...
public class _employeeList__jsp extends com.caucho.jsp.JavaPage{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    org.apache.taglibs.standard.tag.el.core.ParamTag _jsp_tag19 = null;
    ...
    org.apache.taglibs.standard.tag.common.core.ChooseTag _jsp_tag14 = null;
    org.apache.taglibs.standard.tag.el.core.WhenTag _jsp_tag15 = null;
    org.apache.taglibs.standard.tag.common.core.OtherwiseTag _jsp_tag16 = null;
    org.apache.taglibs.standard.tag.el.core.OutTag _jsp_tag17 = null;
    org.apache.taglibs.standard.tag.el.core.OutTag _jsp_tag18 = null;
    try {
      pageContext.write(_jsp_string0, 0, _jsp_string0.length);
      pageContext.write(_jsp_string0, 0, _jsp_string0.length);
      com.eurocash.data.ItemListBean employeeListBean;
      synchronized (session) {
        employeeListBean = (com.eurocash.data.ItemListBean) session.getAttribute("employeeListBean");
        if (employeeListBean == null) {
          employeeListBean = new com.eurocash.data.ItemListBean();
          session.setAttribute("employeeListBean", employeeListBean);
        }
      }
      pageContext.write(_jsp_string1, 0, _jsp_string1.length);
      com.eurocash.data.mapping.form.FormMappingObject employeeListForm;
      synchronized (session) {
        employeeListForm = (com.eurocash.data.mapping.form.FormMappingObject) session.getAttribute("employeeListForm");
          ...
          try {
            ...
            if (_caucho_expr_6.evalBoolean(pageContext)) {
              ...
              if (_jsp_tag11 == null) {
                ...
                _jsp_tag11.setItems("${employeeListBean.list}");
                _jsp_tag11.setVar("employee");
              }
              ...
              try {
                ...
                if (_jspEval13 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  do {
                    ...
                    pageContext.write(_jsp_string21, 0, _jsp_string21.length);
                    if (_caucho_expr_18.print(pageContext.getWriteStream(), pageContext, true)) {
                      com.caucho.el.Expr.toStreamEscaped(pageContext.getWriteStream(), "N/A");
                    }
              ...
              try {
                ...
                if (_jspEval16 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  if (_jsp_tag19 == null) {
                    _jsp_tag19 = new org.apache.taglibs.standard.tag.el.core.ParamTag();
                    _jsp_tag19.setPageContext(pageContext);
                    _jsp_tag19.setParent(_jsp_tag0);
                  }

                  _jsp_tag19.setName("domain");
                  _jsp_tag19.setValue("employee");
                  _jsp_tag19.doStartTag();
                  _jsp_tag19.setBodyContent(null);
                  int _jsp_endTagVar20 = _jsp_tag19.doEndTag();
                  if (_jsp_endTagVar20 == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
                    return;
                  pageContext.write(_jsp_string32, 0, _jsp_string32.length);
                  _jsp_tag19.setName("listBean");
                  _jsp_tag19.setValue("employeeListBean");
                  _jsp_tag19.doStartTag();
                  _jsp_tag19.setBodyContent(null);
                  int _jsp_endTagVar24 = _jsp_tag19.doEndTag();
              ...
              throws javax.servlet.ServletException
            {
              ...
              _caucho_line_map = new com.caucho.java.LineMap("_employeeList__jsp.java", "/administration/employeeList.jsp");
              _caucho_line_map.add(1, 1);
              _caucho_line_map.add(1, 46);
              _caucho_line_map.add(3, 47);
              _caucho_line_map.add(5, 48);
              _caucho_line_map.add(6, 57);
              _caucho_line_map.add(7, 65);
              _caucho_line_map.add(8, 74);
              _caucho_line_map.add(23, 83);
              _caucho_line_map.add(23, 94);
              _caucho_line_map.add(30, 105);
              _caucho_line_map.add(30, 110);
              _caucho_line_map.add(46, 121);
              _caucho_line_map.add(46, 122);
              _caucho_line_map.add(47, 125);
              _caucho_line_map.add(47, 139);
              _caucho_line_map.add(48, 142);
              _caucho_line_map.add(48, 143);
              _caucho_line_map.add(48, 146);
              _caucho_line_map.add(52, 158);
              _caucho_line_map.add(74, 160);
              _caucho_line_map.add(81, 165);
              _caucho_line_map.add(81, 179);
              _caucho_line_map.add(83, 182);
              _caucho_line_map.add(86, 186);
              _caucho_line_map.add(89, 190);
              _caucho_line_map.add(90, 192);
              _caucho_line_map.add(91, 194);
              _caucho_line_map.add(91, 196);
              _caucho_line_map.add(92, 198);
              _caucho_line_map.add(95, 203);
              _caucho_line_map.add(96, 205);
              _caucho_line_map.add(97, 207);
              _caucho_line_map.add(102, 215);
              _caucho_line_map.add(104, 219);
              _caucho_line_map.add(116, 235);
              _caucho_line_map.add(116, 246);
              _caucho_line_map.add(117, 257);
              _caucho_line_map.add(118, 261);
              _caucho_line_map.add(118, 265);
              com.caucho.vfs.Depend depend;
              depend = new com.caucho.vfs.Depend(appDir.lookup("administration/employeeList.jsp"), 1086398531000L, 5459L);
            ...
            private static com.caucho.el.Expr _caucho_expr_0 =
              new com.caucho.el.EqExpr(6, new com.caucho.el.LongLiteral(0L), new com.caucho.el.ArrayExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("employeeListForm"), new com.caucho.el.StringLiteral("htmlData")), new com.caucho.el.StringLiteral("agencyId")));
            ...
            private static com.caucho.el.Expr _caucho_expr_5 =
              new com.caucho.el.ArrayExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("employeeListForm"), new com.caucho.el.StringLiteral("htmlData")), new com.caucho.el.StringLiteral("name"));
            private static com.caucho.el.Expr _caucho_expr_6 =
              new com.caucho.el.UnaryExpr(16, new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("employeeListBean"), new com.caucho.el.StringLiteral("list")));
            private static com.caucho.el.Expr _caucho_expr_7 =
              new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("employee"), new com.caucho.el.StringLiteral("id"));
            ...
            private static com.caucho.el.Expr _caucho_expr_10 =
              new com.caucho.el.ArrayExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("agenciesBean"), new com.caucho.el.StringLiteral("agenciesMap")), new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("employee"), new com.caucho.el.StringLiteral("agencyId"))), new com.caucho.el.StringLiteral("company"));
            private static com.caucho.el.Expr _caucho_expr_11 =
              new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("employee"), new com.caucho.el.StringLiteral("lastName"));
            private static com.caucho.el.Expr _caucho_expr_12 =
              new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("employee"), new com.caucho.el.StringLiteral("firstName"));
            private static com.caucho.el.Expr _caucho_expr_13 =
              new com.caucho.el.BooleanExpr(12, new com.caucho.el.BooleanExpr(12, new com.caucho.el.EqExpr(6, new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("employee"), new com.caucho.el.StringLiteral("address")), new com.caucho.el.NullLiteral()), new com.caucho.el.EqExpr(6, new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("employee"), new com.caucho.el.StringLiteral("postalCode")), new com.caucho.el.NullLiteral())), new com.caucho.el.EqExpr(6, new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("employee"), new com.caucho.el.StringLiteral("city")), new com.caucho.el.NullLiteral()));
            private static com.caucho.el.Expr _caucho_expr_14 =
              new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("employee"), new com.caucho.el.StringLiteral("address"));
            private static com.caucho.el.Expr _caucho_expr_15 =
              new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("employee"), new com.caucho.el.StringLiteral("postalCode"));
            private static com.caucho.el.Expr _caucho_expr_16 =
              new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("employee"), new com.caucho.el.StringLiteral("city"));
            private static com.caucho.el.Expr _caucho_expr_17 =
              new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("employee"), new com.caucho.el.StringLiteral("phone"));
            private static com.caucho.el.Expr _caucho_expr_18 =
              new com.caucho.el.ArrayExpr(new com.caucho.el.IdExpr("employee"), new com.caucho.el.StringLiteral("cellPhone"));
            ...
            static {
              ...
              _jsp_string1 = "\n".getBytes();
              _jsp_string29 = "'; document.listForm.action.value='delete'; document.listForm.subAction.value='one'; document.listForm.submit();\"/>\n					</td>\n				</tr>\n				".getBytes();
              ...
              _jsp_string14 = "\n				<!-- employee id ".getBytes();
              _jsp_string22 = "&nbsp;".getBytes();
