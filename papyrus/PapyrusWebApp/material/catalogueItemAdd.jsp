...
<jsp:useBean id="catalogueItemAddForm" class="com.eurocash.data.mapping.form.FormMappingObject" scope="session" />
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Ajout Catalogue Référence</title>
	...
	<body>
		...
		<h1 class="title">Catalogue Références&nbsp;&nbsp;:&nbsp;:&nbsp;&nbsp;Ajout</h1>
		...
		<div class="boxTitle">&nbsp;&nbsp;Informations: </div>
			<div class="boxCol">
				...
				<c:if test="${not empty catalogueAddForm.errorFields['reference']}" >
			...
			<div class="boxCol" id="firstNameBox">
				...
				<c:if test="${not empty catalogueAddForm.errorFields['designation']}" >
