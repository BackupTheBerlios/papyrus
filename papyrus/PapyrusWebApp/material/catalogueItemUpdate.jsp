...
<jsp:useBean id="catalogueItemUpdateForm" class="com.eurocash.data.mapping.form.FormMappingObject" scope="session" />
	...
	<body>
		...
		<div class="boxTitle">&nbsp;&nbsp;Informations: </div>
			<div class="boxCol">
				...
				<p class="boxInput"><input type="text" name="reference" value="<c:out value="${catalogueUpdateForm.htmlData['reference']}" />"></p>
				<c:if test="${not empty catalogueUpdateForm.errorFields['reference']}" >
					<p class="boxError"><img src="/include/pictures/warning.png">&nbsp;&nbsp;&nbsp;<c:out value="${catalogueUpdateForm.errorFields['reference']}" /></p>
				</c:if>
			</div>
			<div class="boxCol" id="firstNameBox">
				<p class="boxField">&nbsp;&nbsp;Désignation :</p>
				<p class="boxInput"><input type="text" name="designation" value="<c:out value="${catalogueUpdateForm.htmlData['designation']}" />"></p>
				<c:if test="${not empty catalogueUpdateForm.errorFields['designation']}" >
					<p class="boxError"><img src="/include/pictures/warning.png">&nbsp;&nbsp;&nbsp;<c:out value="${catalogueUpdateForm.errorFields['designation']}" /></p>
				</c:if>
			</div>
			<div class="boxCol">
		...
		<div class="boxAction">
			...
			<a class="classicButtonRed" onclick="window.location.href = '/DomainActionServlet?domain=catalogue&action=list&subAction=init';">&nbsp;Annuler&nbsp;</a>
		</div>
