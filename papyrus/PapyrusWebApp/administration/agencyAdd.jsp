...
<jsp:useBean id="agencyAddForm" class="com.eurocash.data.mapping.form.FormMappingObject" scope="session" />
	...
	<body>
		...
		<div class="boxTitle">&nbsp;&nbsp;Identité: </div>
			<div class="boxCol">
				...
				<p class="boxInput"><input type="text" name="lastName" value="<c:out value="${agencyAddForm.htmlData['lastName']}" />"></p>
				<c:if test="${not empty agencyAddForm.errorFields['lastName']}" >
					<p class="boxError"><img src="/include/pictures/warning.png">&nbsp;&nbsp;&nbsp;<c:out value="${agencyAddForm.errorFields['lastName']}" /></p>
				</c:if>
			</div>
		</div>
		...
		<div class="boxTitle">&nbsp;&nbsp;Coordonnées: </div>
			...
			<div class="boxCol">
				...
				<p class="boxInput"><input type="text" name="mail" value="<c:out value="${agencyAddForm.htmlData['email']}" />"></p>
			</div>
		</div>
