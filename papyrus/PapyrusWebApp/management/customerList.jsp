...
<jsp:useBean id="customerListBean" class="com.eurocash.data.ItemListBean" scope="session" />
<jsp:useBean id="customerListForm" class="com.eurocash.data.mapping.form.FormMappingObject" scope="session" />
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="boxCol">
			...
			<p class="boxSearch">Code client:&nbsp;<input type="text" name="customerCode" length="30" value="<c:out value="${customerListForm.htmlData['customerCode']}" />"></p>
			<p class="boxSearch">Nom:&nbsp;<input type="text" name="name" length="30" value="<c:out value="${customerListForm.htmlData['name']}" />"></p>
			<p class="boxSearch">Adresse:&nbsp;<input type="text" name="address" length="30" value="<c:out value="${customerListForm.htmlData['address']}" />"></p>
			<p class="boxSearch">Ville:&nbsp;<input type="text" name="city" length="30" value="<c:out value="${customerListForm.htmlData['city']}" />"></p>
			<p class="boxSearch">Code Postal:&nbsp;<input type="text" name="postalCode" length="30" value="<c:out value="${customerListForm.htmlData['postalCode']}" />"></p>
			<p class="boxSearch">Téléphone:&nbsp;<input type="text" name="phone" length="30" value="<c:out value="${customerListForm.htmlData['phone']}" />"></p>
			<p class="boxSearch">Portable:&nbsp;<input type="text" name="cellPhone" length="30" value="<c:out value="${customerListForm.htmlData['cellPhone']}" />"></p>
		</div>
