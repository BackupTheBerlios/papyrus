...
<jsp:useBean id="agencyListBean" class="com.papyrus.data.ItemListBean" scope="session" />
<jsp:useBean id="agencyListForm" class="com.papyrus.data.mapping.form.FormMappingObject" scope="session" />
	...
	<body>
		...
		<div class="boxCol">
			...
			<div class="boxSearch">
				...
				<p class="boxInput"><input type="text" name="name" length="30" value="<c:out value="${agencyListForm.htmlData['name']}" />"></p>
			</div>
